        ...
        document.getElementById('aiForm').addEventListener('submit', function(e) {
            ...
            axios.post('{{ route('user.eksplorasi.store') }}', formData, {
                ...
                .then(function(response) {
                    ...
                    document.getElementById('resComposition').textContent = data.composition;
                    document.getElementById('resHandling').textContent = data.handling;
                    document.getElementById('resRecycling').textContent = data.recycling;
                    document.getElementById('resImpact').textContent = data.impact;
