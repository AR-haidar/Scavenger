<x-app-layout>
    <x-slot name="header">
        <div
            ...
            <div class="">
                <x-breadcrumb :items="[['label' => 'Sampah']]" />
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg px-6 py-3">
            ...
            <div class="mb-4 border-b border-gray-200 flex justify-between">
                <div class="">
                    <ul class="flex flex-wrap-mb-px text-sm font-medium text-center">
                        <li class="mr-2">
                            <a href="{{ route('admin.waste.index', ['search' => request('search')]) }}"
                        ...
                        <li class="mr-2">
                            <a href="{{ route('admin.waste.index', ['category' => 'organik', 'search' => request('search')]) }}"
                        ...
                        <li class="mr-2">
                            <a href="{{ route('admin.waste.index', ['category' => 'anorganik', 'search' => request('search')]) }}"
                        ...
                        <li class="mr-2">
                            <a href="{{ route('admin.waste.index', ['category' => 'b3', 'search' => request('search')]) }}"
            ...
            <div class="flex justify-end mb-3">
                <div class="flex flex-col">
                    <form method="GET" action="{{ route('admin.waste.index') }}" class="max-w-md">
                        <div class="relative">
                    ...
                    @if (request('search'))
                        <div class="mt-3 flex items-center space-x-2 text-sm">
                            ...
                            <a href="{{ route('admin.waste.index', request()->only('category')) }}"
            ...
            @else
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 text-center py-12">
                    ...
                    @else
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">Belum ada data sampah</h3>
                        <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan data sampah baru.</p>
                        <div class="mt-6">
                            <a href="{{ route('admin.waste.create') }}"
                                class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 text-sm font-extrabold">
